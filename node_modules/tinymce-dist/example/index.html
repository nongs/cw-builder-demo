...
<html>
<head>
  <title>Tinymce full example</title>
  <script type="text/javascript" src="https://cdn.rawgit.com/sadiqhabib/tinymce-dist/master/tinymce.full.js"></script>
  <!-- <script type="text/javascript" src="../tinymce.full.js"></script> -->
</head>
<body>
  <div class="container">
...
<script type="text/javascript">
  ...
  //   content_css: '../skins/lightgray/codepen.css'
  // });
